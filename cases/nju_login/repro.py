...
其中：
  - pwdEncryptSalt：登录页隐藏字段 #pwdEncryptSalt 的值（16 字节 → AES-128 key）
...
LOGIN_URL = (
    ...
    "?service=https%3A%2F%2Foa.nju.edu.cn%3A443%2Foa2"
)
...
def fetch_form(session: requests.Session):
    ...
    return {
        ...
        "execution": _field(html, "execution") or "e2s1",
        "lt": _field(html, "lt"),
